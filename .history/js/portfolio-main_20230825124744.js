...
document.addEventListener("DOMContentLoaded", function () {
  ...
  async function AddServiceData(newService) {
    try {
      ...
      // You can add UI feedback here indicating successful addition
  
    } catch (error) {
      console.error('Error:', error);
  
      // Add UI feedback to inform the user of the error
      // For example, display a message saying "Service addition failed"
    }
  }
