...
document.addEventListener("DOMContentLoaded", function () {
    ...
    for (const [index, item] of Object.entries(sliderItems)) {
      if (index < sliderItems.length - 1) {
        item.addEventListener("click", function () {
          displayServiceDetail(parseInt(index));
        });
      }
    }
  }
  ...
  function displayServiceDetail(itemID) {
  ...
  async function AddServiceData(newService) {
    ...
    const servicesInitialData = [{ title: 'DEVELOP', description: 'We are a dedicated and proficient website development service provider, committed to crafting impactful online solutions for businesses across diverse industries.With a team of skilled developers, designers, and digital strategists, we offer comprehensive website development services that transcend mere online presence.Our approach begins by understanding your unique business objectives and target audience. Leveraging cutting-edge technologies and industry best practices, we meticulously design and develop websites that are not only visually stunning but also functionally robust.From responsive designs that adapt seamlessly to different devices to user-friendly interfaces that enhance engagement, we ensure every element contributes to an exceptional user experience.', image_url: 'res/ic_develop.png' },
    { title: 'TEST', description: 'Our website testing services guarantee a flawless digital experience.Our adept team meticulously examines functionality, usability, compatibility, and security, ensuring your website performs seamlessly across devices and platforms. We identify and rectify glitches, optimize loading speeds, and fortify your site against cyber threats.Detailed reports and recommendations guide enhancements.Whether launching or refining a site, our testing ensures your digital presence aligns with your vision, providing users with a reliable, secure, and engaging platform.', image_url: 'res/ic_test.png' },
    { title: 'DEPLOY', description: 'Our website deployment service offers a seamless transition from development to the online sphere, ensuring your website goes live flawlessly.With a focus on efficiency and precision, we take the complexity out of the deployment process, enabling you to reach your audience without disruptions.Our experienced team leverages industry best practices to guarantee a smooth deployment.We meticulously configure servers, databases, and hosting environments, optimizing performance and security. From managing domain configurations to handling SSL certificates, we ensure your website is fully functional and secure.We understand the importance of minimal downtime during deployment.Our strategies minimize disruption, and thorough testing after deployment guarantees that all components work seamlessly.We provide comprehensive post-deployment support, resolving any unforeseen issues promptly.', image_url: 'res/ic_deploy.png' },
    { title: 'OPTIMIZE', description: 'Our website optimization service is designed to enhance your online presence by maximizing performance, user experience, and conversion rates.With a strategic blend of technical expertise and data-driven insights, we ensure your website operates at peak efficiency.Our team conducts in-depth performance analysis, identifying bottlenecks that might hinder loading speeds and overall responsiveness. We implement techniques like image compression, browser caching, and code minification to accelerate page loading times, ensuring visitors stay engaged.User experience is paramount. We optimize navigation, improve mobile responsiveness, and enhance overall usability, resulting in higher visitor satisfaction.Conversion-focused strategies include optimizing call-to-action placement and streamlining checkout processes for e-commerce sites.Search engine visibility is amplified through on-page and technical SEO optimization. Our service also emphasizes security, implementing measures to safeguard user data and protect against cyber threats.', image_url: 'res/ic_optimize.png' }];


    for (service in servicesInitialData) {
  ...
  function DisplayIntroData(userData) {
    ...
    (async () => {
      ...
      console.log("Work Experience 2 is:", workExp);
