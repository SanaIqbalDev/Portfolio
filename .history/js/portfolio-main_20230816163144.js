...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const submitInfoForm = document.getElementById("service-info-form");

  submitInfoForm.addEventListener("submit", (e) => {
    e.preventDefault();
  ...
  //Adding new services item dunamically in the list
