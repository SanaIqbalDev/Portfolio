...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function addItem(a, b, c, d, addtoDataSet) {
    ...
    if (c === "") {
      ...
      const blob = new Blob([c], { type: 'image/png' });
      ...
      reader.onload = function (event) {
        ...
        // Log the data URL to the console for inspection
        console.log('Data URL:', dataUrl);

        // Optionally, you can display this data URL in an <img> element for a visual check
        const imgElement = document.getElementById('validationImgElement');
