...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const newItemUrl = "https://firebasestorage.googleapis.com/v0/b/portfolioimagestorage.appspot.com/o/images%2Fic_new_item.png?alt=media&token=c93df4c6-1d5a-43ad-bddc-ac0219bd98c5";
  ...
  function editItem() {
    ...
    if (isSearchFocused) { DisableSearch(); }
  ...
  function addItem(a, b, c, d, addtoDataSet) {
    ...
    internalDiv.addEventListener("click", function () {
      ...
      FetchServiceDetailWithId(parseInt(internalDiv.parentElement.id), false)
  ...
  function RemoveServiceData(selectedItem, service_id) {
  ...
  function UpdateServiceItem(serviceObject) {
  ...
  function FetchServiceDetailWithId(service_id, is_edit) {
